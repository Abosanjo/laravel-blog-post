    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-stick-dark" data-navbar="sticky">
      <div class="container">
        ...
        <section class="navbar-mobile">
          ...
          <div   id="ip1">
            <form class="input-group" acttion="{{ route('welcome') }}" method="GET">
        ...
        <div class="row gap-y align-items-center">
          ...
          <div class="col-lg-6">
            <div class="nav nav-bold nav-uppercase nav-trim justify-content-lg-center">
              ...
              <a class="nav-link" href="{{ route('coming.index') }}">Blog</a>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5eb43dde3a44b1b7"></script>
