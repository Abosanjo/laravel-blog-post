...
@section('header')
    ...
    <!-- Header -->
    <header class="header text-white h-fullscreen pb-80" style="background-image: url( /img/{{ $post->image }} );" data-overlay="9">
      <div class="container text-center">
        ...
        <div class="row h-100">
          <div class="col-lg-8 mx-auto align-self-center">
            ...
            <p> <img src="/img/profile/{{  $post->user->photo }}" class="img-circle elevation-2"  alt="User Image"
              style="width:80px; height:80px;  border-radius:50%;"></p>
...
s.src = 'https://saas-blog-pftma327e2.disqus.com/embed.js';
