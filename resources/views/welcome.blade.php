    ...
    <header class="header text-white h-fullscreen overflow-hidden" style="background-image: linear-gradient(-45deg, #667eea 0%, #764ba2 100%);">
      ...
      <div class="container position-static">
        <div class="row align-items-center h-100">
          ...
          <div class="col-lg-7">
            <h1 class="display-4 fw-500">Built For <span class="fw-400 pl-2" data-typing="Startups, Entrepreneurs, Advertising, Developers, SaaS, WebApp" data-type-speed="80"></span></h1>
            <p class="lead mt-5 mb-7 mb-md-9 w-80"><strong>TheSaaS</strong> is an elegant, modern and fully customizable and WebApp powered by H2O</p>
            <a class="btn btn-xl btn-round btn-success w-200 mr-3 px-6 d-none d-md-inline-block" href="">Join us</a>
            <a class="btn btn-xl btn-round btn-outline-light w-200 px-6" href="#section-demo"> Articles</a>
          </div>
        ...
        <div class="container">
          ...
          <div class="col-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
            ...
            <a class="card shadow-1 hover-shadow-7" href="{{ route('blog.show', $post->id) }}" >
              ...
              <div class="badges">
                <a class="badge badge-info" href="{{ route('blog.show', $post->id) }}"> {{ $post->category->name }}</a>
              </div>
              </div>


              <div class="card-body">
              <strong>  <a href="{{ route('blog.show', $post->id) }}" class="block text-gray-800 font-semibold text-2xl mt-2 hover:text-gray-600 hover:underline">{{ $post->title}}</a></strong>
                <p class="small-1">{{ $post->description }}</p>
                <a class="fw-600 fs-12" href="{{ route('blog.show', $post->id) }}">Read more <i class="ti-angle-right fs-7 pl-2"></i></a>
        ...
        <div class="container">
          <div class="row gap-y align-items-center">
            ...
            <div class="col-lg-6">
              ...
              <h2 class="mb-5">Advertisments</h2>
            ...
            <div class="col-lg-5 ml-lg-auto d-none d-lg-block">
              <img src="{{ asset('img/blocks-and-elements.png') }}" alt="...">
            </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6 mx-auto">
              <p><img src="{{ asset('img/rocket2.png') }}" alt="join us"></p>
              <br>
              ...
              <br>
              <a class="btn btn-xl btn-round btn-info px-7" href="">Policy </a>
            </div>
          </div>
            ...
            <div class="p-5">
              <div class="card border hover-shadow-6">
                <div class="card-body px-5">
                  ...
                  <p class="small-2 text-lighter mb-0">By <a class="text-inherit" href="" target="_blank"><em>coolrebel</em></a></p>
            ...
            <div class="p-5">
              <div class="card border hover-shadow-6">
                <div class="card-body px-5">
                  ...
                  <p class="small-2 text-lighter mb-0">By <a class="text-inherit" href="" target="_blank"><em>yorickgroeven</em></a></p>
            ...
            <div class="p-5">
              <div class="card border hover-shadow-6">
                <div class="card-body px-5">
                  ...
                  <p class="small-2 text-lighter mb-0">By <a class="text-inherit" href="" target="_blank"><em>epino</em></a></p>
            ...
            <div class="p-5">
              <div class="card border hover-shadow-6">
                <div class="card-body px-5">
                  ...
                  <p class="small-2 text-lighter mb-0">By <a class="text-inherit" href="" target="_blank"><em>pepsit36</em></a></p>
            ...
            <div class="p-5">
              <div class="card border hover-shadow-6">
                <div class="card-body px-5">
                  ...
                  <p class="small-2 text-lighter mb-0">By <a class="text-inherit" href="" target="_blank"><em>Its_Complete</em></a></p>
            ...
            <div class="p-5">
              <div class="card border hover-shadow-6">
                <div class="card-body px-5">
                  ...
                  <p class="small-2 text-lighter mb-0">By <a class="text-inherit" href="" target="_blank"><em>KungWoo</em></a></p>
            ...
            <div class="p-5">
              <div class="card border hover-shadow-6">
                <div class="card-body px-5">
                  ...
                  <p class="small-2 text-lighter mb-0">By <a class="text-inherit" href="" target="_blank"><em>webserviz</em></a></p>
      ...
      <section class="section text-white py-8">
        ...
        <div class="container">
          <header class="section-header">
            ...
            <h2 class="display-3 fw-400">join   <span class="mark-underline">Now</span></h2>
            <hr>
          ...
          <p class="text-center">
            <a class="btn btn-xl btn-round btn-light w-250" href="">be part<span class="pl-2"></span></a><br>
            <small><a class="text-white opacity-80" href="">society </a></small>
          </p>
        </div>
      </section>
